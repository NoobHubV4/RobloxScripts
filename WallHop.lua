...
container.Size = UDim2.new(0.25, 0, 0.15, 0)  -- Adjust size for a slightly smaller container
...
flickButton.Size = UDim2.new(0.6, 0, 0.6, 0)  -- Adjust size for a slightly bigger flick button
